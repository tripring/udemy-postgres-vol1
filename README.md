...
| 02 | 受注管理画面や経営ダッシュボードが遅くなり、現場から苦情が届く | `pg_stat_activity`、`pg_stat_statements`、実行計画、インデックス、マテリアライズドビュー |
| 03 | フラッシュセールで残り1個の商品が二重購入され、在庫がマイナスになる | トランザクション、ロック、デッドロック、楽観ロック |
| 04 | 注文テーブルが肥大化し、月次レポートが終わらなくなる | パーティショニング、プルーニング、パーティション運用 |
